...
def drawCavity():
    ...
    endG12 = np.array([62.58258258258258, 57.53753753753754, 17.207207207207208, 12.002002002002001, 80.38038038038039,
                       93.31191678718535, 171.1929]) * 1e-3
    # # TESLA end cell 2
    A_m, B_m, a_m, b_m, Ri_m, L_m, Req_m = midG12
    A_el, B_el, a_el, b_el, Ri_el, L_el, Req_el = endG12
    A_er, B_er, a_er, b_er, Ri_er, L_er, Req_er = endG12
    ...
    # with open(r'D:\Dropbox\CEMCodesHub\C1092V\PostprocessingData\Data\End_cell Sol AA.txt', 'w') as fil:
    # with open(r'D:\Dropbox\CEMCodesHub\C1092V\PostprocessingData\Data\End_cell Sol AA.txt', 'w') as fil:
    # with open(r'D:\Dropbox\CEMCodesHub\C1092V\PostprocessingData\Data\TESLA_End_cell2.txt', 'w') as fil:
