...
class Cavities:
    ...
    def qois(self, cavity, op_field):
        """
        Retrieves the power figures of merit of a Cavity object
        :param cavity: Cavity object
        :param op_field: Operating field
        :return: dictionary containing the quantieis of interest
        """
