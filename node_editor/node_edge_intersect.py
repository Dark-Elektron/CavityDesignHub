...
class EdgeIntersect:
    ...
    def enterState(self, node: "Node"):
        ...
        :param node: :class:`~node_editor.node_node.Node` which we started to drag
    ...
    def hotZoneRect(self, node: 'Node') -> 'QRectF':
        ...
        :param node: :class:`~node_editor.node_node.Node` for which we want to get `QRectF` describing its position and area
        :type node: :class:`~nodeeditor.node_node.Node`
    ...
    def intersect(self, node_box: 'QRectF') -> 'Edge':
        ...
        :return: :class:`~node_editor.node_edge.Edge` or `None` if the node is being cut by an `Edge`
    ...
    def isConnected(self, node: 'Node'):
        ...
        :param node: :class:`~node_editor.node_node.Node` which connections to check
        :type node: :class:`~nodeeditor.node_node.Node`
        :return:
        """
