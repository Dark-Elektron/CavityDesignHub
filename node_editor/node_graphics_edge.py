...
class QDMGraphicsEdge(QGraphicsPathItem):
    ...
    def createEdgePathCalculator(self):
        """Create instance of :class:`~node_editor.node_graphics_edge_path.GraphicsEdgePathBase`"""
        self.pathCalculator = self.determineEdgePathClass()(self)
    ...
    def determineEdgePathClass(self):
        ...
        from node_editor.node_edge import EDGE_TYPE_BEZIER, EDGE_TYPE_DIRECT, EDGE_TYPE_SQUARE
    ...
    def paint(self, painter, QStyleOptionGraphicsItem, widget=None):
        """Qt's overridden method to paint this Graphics Edge. Path calculated
            in :func:`~node_editor.node_graphics_edge.QDMGraphicsEdge.calcPath` method"""
    ...
    def calcPath(self) -> QPainterPath:
        ...
        is an instance of derived :class:`~node_editor.node_graphics_edge_path.GraphicsEdgePathBase` class
