# -*- coding: utf-8 -*-
"""
A module containing the Edge Snapping functions which are used in :class:`~node_editor.node_graphics_view.QDMGraphicsView` class.
"""
...
class EdgeSnapping():
    ...
    def getSnappedSocketItem(self, event: 'QMouseEvent') -> 'QDMGraphicsSocket':
        """Returns :class:`~node_editor.node_graphics_socket.QDMGraphicsSocket` which we should snap to"""
