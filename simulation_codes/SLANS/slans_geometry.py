...
class SLANSGeometry(Geometry):
    ...
    def cavity(self, no_of_cells=1, no_of_modules=1, mid_cells_par=None, l_end_cell_par=None, r_end_cell_par=None, fid=None, bc=33, f_shift='default', beta=1, n_modes=None, beampipes=None,
               parentDir=None, projectDir=None):
        # print_(mid_cells_par, l_end_cell_par)
        if not n_modes:
            n_modes = no_of_cells + 1 # intentianal because the accuracy of the last mode is always low
