...
from simulation_codes.SLANS.slans_code import SLANS, SLANS_Multicell
import numpy as np
            ...
            if n > 1:
                ...
                if self.WG_R > 0:
                    if end_R == 2:
                        f.write('1 {:g} {:g} 0 1 {:.0f} 0 5 0\n'.format(
                            self.WG_L + self.WG_R + self.L_L + self.L_R +
                            2 * sum(self.L_M), self.Rbp_R, self.WG_mesh))
                    else:
                        f.write('1 {:g} {:g} 0 1 {:.0f} 0 5 0\n'.format(
                            self.WG_L + self.WG_R + self.L_L + self.L_R +
                            2 * sum(self.L_M), self.Rbp_R, self.WG_mesh))
                ...
                if end_R == 2:
                    f.write('1 {:g} {:g} 0 1 0 {:.0f} {:.0f} 0\n'.format(
                        self.WG_L + self.WG_R + self.L_L + self.L_R + 2 * sum(self.L_M), self.ri_R,
                        -(self.Jxy_all_bp[5] + self.Jxy_all_bp[6] + self.Jxy_all_bp[7]), BC_Right))

                f.write('1 {:g} 0 0 1 0 {:.0f} {:.0f} 0\n'.format(
                    self.WG_L + self.WG_R + self.L_L + self.L_R + 2 * sum(self.L_M), -self.Jy0, BC_Right))
...
if __name__ == '__main__':
    ...
    cell_pars = [
            ...
            [100, 58, 30, 30, 70, 93.5, 172.041, 0],
            [10, 58, 30, 30, 70, 93.5, 172.041, 0],
            [50, 58, 30, 30, 70, 93.5, 172.041, 0],
            [10, 58, 30, 30, 70, 93.5, 172.041, 0],
            [60, 60, 20, 20, 72, 97.9485, 172.041, 0]]

    parentDir = "D:\Dropbox\Files"
    projectDir = "Test_multicell"
    slg.cavity_multicell(cells_par=cell_pars, parentDir=parentDir, projectDir=projectDir, fid='Test')
