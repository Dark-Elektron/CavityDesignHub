...
class ABCI_flattop:
    ...
    def __init__(self, left_beam_pipe, left_end_cell, mid_cell, right_end_cell, right_beam_pipe):
        ...
        self.a_R = self.right_end_cell[5]
        self.b_R = self.right_end_cell[6]
        self.l_R = self.right_end_cell[7]
    ...
    def abci_n1_R(self, n, zr12_R, WG_L, f):
        ...
        if n == 1:
            ...
            f.write('{} {}\n'.format(zr12_R[0][1], WG_L + self.L_L + self.l_L + zr12_R[0][0]))
            f.write('{} {}\n'.format(zr12_R[1][1], WG_L + self.L_L + self.l_L + zr12_R[1][0]))
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_R + self.b_R, WG_L + self.L_L + self.l_L + self.L_R))
            f.write('{} {}\n'.format(self.ri_R, WG_L + self.L_L + self.l_L + self.L_R))

        if n > 1:
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Req_R - self.B_R, WG_L + self.L_L + 2 * (n - 1) * self.L_M + self.l_L + (n - 2) * self.l_M + self.l_R))
            f.write('{} {}\n'.format(zr12_R[0][1], WG_L + self.L_L + 2 * (n - 1) * self.L_M + self.l_L + (n - 2) * self.l_M + self.l_R + zr12_R[0][0]))

            f.write('{} {}\n'.format(zr12_R[1][1], WG_L + self.L_L + 2 * (n - 1) * self.L_M + self.l_L + (n - 2) * self.l_M + self.l_R + zr12_R[1][0]))

            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_R + self.b_R, WG_L + self.L_L + 2 * (n - 1) * self.L_M + self.L_R + self.l_L + (n - 2) * self.l_M + self.l_R))
            f.write('{} {}\n'.format(self.ri_R, WG_L + self.L_L + 2 * (n - 1) * self.L_M + self.L_R + self.l_L + (n - 2) * self.l_M + self.l_R))
    ...
    def abci_bp_R(self, n, zr12_BPR, WG_L, f):
        ...
        if n == 1:
            ...
            f.write('{} {}\n'.format(zr12_BPR[1][1], WG_L + self.L_L + self.l_L + self.L_R + self.x_R - zr12_BPR[1][0]))
            f.write('{} {}\n'.format(zr12_BPR[0][1], WG_L + self.L_L + self.l_L + self.L_R + self.x_R - zr12_BPR[0][0]))
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Rbp_R - self.c_R, WG_L + self.L_L + self.l_L + self.L_R + self.x_R))
            f.write('{} {}\n'.format(self.Rbp_R, WG_L + self.L_L + self.l_L + self.L_R + self.x_R))

        if n > 1:
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_R + self.bt_R, WG_L + self.L_L + self.l_L + self.L_R + 2 * (n - 1) * self.L_M + (n - 2) * self.l_M + self.l_R))
            f.write('{} {}\n'.format(zr12_BPR[1][1],
                                     WG_L + self.L_L + self.l_L + self.L_R + self.x_R - zr12_BPR[1][0] + 2 * (n - 1) * self.L_M + (n - 2) * self.l_M + self.l_R))
            f.write('{} {}\n'.format(zr12_BPR[0][1],
                                     WG_L + self.L_L + self.l_L + self.L_R + self.x_R - zr12_BPR[0][0] + 2 * (n - 1) * self.L_M + (n - 2) * self.l_M + self.l_R))
            f.write('-3., 0.000\n')
            f.write(
                '{} {}\n'.format(self.Rbp_R - self.c_R, WG_L + self.L_L + self.l_L + self.L_R + self.x_R + 2 * (n - 1) * self.L_M + (n - 2) * self.l_M + self.l_R))
            f.write('{} {}\n'.format(self.Rbp_R, WG_L + self.L_L + self.l_L + self.L_R + self.x_R + 2 * (n - 1) * self.L_M + (n - 2) * self.l_M + self.l_R))
    ...
    def abci_M(self, n, zr12_M, WG_L, f, i, end_type):
        ...
        if i == 1 and end_type == 1:
            ...
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Req_L - self.B_M, WG_L + self.L_L + (2 * i - 2) * self.L_M + self.l_L))
            f.write('{} {}\n'.format(zr12_LM[0][1], WG_L + self.L_L + (2 * i - 2) * self.L_M + zr12_LM[0][0] + self.l_L))

            f.write('{} {}\n'.format(zr12_LM[1][1], WG_L + self.L_L + (2 * i - 2) * self.L_M + zr12_LM[1][0] + self.l_L))

            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_M + self.b_M, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.l_L))
            f.write('{} {}\n'.format(self.ri_M, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.l_L))
            ...
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Req_L - self.B_L, WG_L + self.L_L + (2 * i - 2) * self.L_M + self.l_L))
            f.write('{} {}\n'.format(zr12_L[0][1], WG_L + self.L_L + (2 * i - 2) * self.L_L + zr12_L[0][0] + self.l_L))
            f.write('{} {}\n'.format(zr12_L[1][1], WG_L + self.L_L + (2 * i - 2) * self.L_L + zr12_L[1][0] + self.l_L))
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_M + self.b_L, WG_L + self.L_L + (2 * i - 1) * self.L_L + self.l_L))
            f.write('{} {}\n'.format(self.ri_M, WG_L + self.L_L + (2 * i - 1) * self.L_L + self.l_L))

        if i != 1:
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Req_M - self.B_M, WG_L + self.L_L + (2 * i - 2) * self.L_M + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(zr12_M[0][1], WG_L + self.L_L + (2 * i - 2) * self.L_M + zr12_M[0][0] + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(zr12_M[1][1], WG_L + self.L_L + (2 * i - 2) * self.L_M + zr12_M[1][0] + self.l_L + (i-1) * self.l_M))
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_M + self.b_M, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(self.ri_M, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.l_L + (i-1) * self.l_M))
        ...
        if i == n - 1 and end_type == 1:
            ...
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_M + self.b_M, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(zr12_RM[1][1], WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_M - zr12_RM[1][0] + self.l_L + (i-1) * self.l_M))

            f.write('{} {}\n'.format(zr12_RM[0][1], WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_M - zr12_RM[0][0] + self.l_L + (i-1) * self.l_M))

            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Req_R - self.B_M, WG_L + self.L_L + (2 * i) * self.L_M + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(self.Req_R, WG_L + self.L_L + (2 * i) * self.L_M + self.l_L + (i-1) * self.l_M))
            ...
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_M + self.b_R, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(zr12_R[1][1], WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_R - zr12_R[1][0] + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(zr12_R[0][1], WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_R - zr12_R[0][0] + self.l_L + (i-1) * self.l_M))
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Req_R - self.B_R, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_R + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(self.Req_R, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_R + self.l_L + (i-1) * self.l_M))

        if i != n - 1:
            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.ri_M + self.b_M, WG_L + self.L_L + (2 * i - 1) * self.L_M + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(zr12_M[1][1], WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_M - zr12_M[1][0] + self.l_L + (i-1) * self.l_M))

            f.write('{} {}\n'.format(zr12_M[0][1], WG_L + self.L_L + (2 * i - 1) * self.L_M + self.L_M - zr12_M[0][0] + self.l_L + (i-1) * self.l_M))

            f.write('-3., 0.000\n')
            f.write('{} {}\n'.format(self.Req_M - self.B_M, WG_L + self.L_L + (2 * i) * self.L_M + self.l_L + (i-1) * self.l_M))
            f.write('{} {}\n'.format(self.Req_M, WG_L + self.L_L + (2 * i) * self.L_M + self.l_L + (i-1) * self.l_M))
