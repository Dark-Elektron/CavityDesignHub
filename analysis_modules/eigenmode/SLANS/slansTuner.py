...
class SLANSTune:
    ...
    def mid_cell_tune(self, A, B, a, b, Ri, L, Req_0, freq0, proc=0, f_shift=0, n_modes=1, beta=1):
        self.tuner = fr'{self.projectDir}\SimulationData\SLANS\Tune\_process_{proc}\SLANS_exe\MidCellTune\Superlans_Files\TunedCell.exe'
        self.slans_files = fr'{self.projectDir}\SimulationData\SLANS\Tune\_process_{proc}\SLANS_exe\MidCellTune\Superlans_Files'
        ...
        cwd = fr'{self.projectDir}\SimulationData\SLANS\Tune\_process_{proc}\SLANS_exe\MidCellTune'
    ...
    def end_cell_tune(self, par_in, par_out, freq0, proc, f_shift=0, n_modes=1, beta=1):
        ...
        self.tuner_end = fr'{self.projectDir}\SimulationData\SLANS\Tune\_process_{proc}\SLANS_exe\EndCellTune\Superlans_Files\TunedCellEnd_120421.exe'
        self.slans_files_end = fr'{self.projectDir}\SimulationData\SLANS\Tune\_process_{proc}\SLANS_exe\EndCellTune\Superlans_Files'
        ...
        print("\t\tCalling subprocess, TunedCell\n")
        cwd = fr'{self.projectDir}\SimulationData\SLANS\Tune\_process_{proc}\SLANS_exe\EndCellTune\Superlans_Files'
        print(filepath)
...
if __name__ == '__main__':
    parentDir = "D:\Dropbox\CavityDesignHub" # '<parentDir>\SimulationData\SLANS\Tune\Cavity_process_{proc}\SLANS_exe\MidCellTune\Superlans_Files\TunedCell.exe'
    projectDir = "D:\Dropbox\CavityDesignHub\SampleProject" # '<projectDir>\SimulationData\SLANS\Tune\_process_{proc}\SLANS_exe\MidCellTune\Superlans_Files'
    "D:\Dropbox\CavityDesignHub\SampleProject\SimulationData\SLANS\Tune\_process_0\SLANS_exe\EndCellTune\Superlans_Files\TunedCellEnd_120421.exe"
    # Create tuner object
...
# D:\Dropbox\CavityDesignHub\SampleProject\SimulationData\SLANS\Tune\_process_0\SLANS_exe\EndCellTune\Superlans_Files\tuned
# D:\Dropbox\CavityDesignHub\SampleProject\SimulationData\SLANS\Tune\_process_0\SLANS_exe\EndCellTune\Superlans_Files\tuned