...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/ICO/Knob Info.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/PNG/go-previous-symbolic.symbolic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pb_Expand_Collapse_Log.setIcon(icon2)
        ...
        self.w_Pane.setMinimumSize(QtCore.QSize(0, 75))
        self.w_Pane.setMaximumSize(QtCore.QSize(16777215, 75))
...
"border-radius: 15px;")
        ...
        self.gridLayout_8.addWidget(self.pb_rMisc, 0, 8, 1, 1)
        self.pb_rHome = QtWidgets.QPushButton(self.w_Pane)
        self.pb_rHome.setMinimumSize(QtCore.QSize(50, 50))
        self.pb_rHome.setMaximumSize(QtCore.QSize(75, 75))
