...
"}")
        ...
        self.pb_Power_Calculations = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.pb_Power_Calculations.setMaximumSize(QtCore.QSize(200, 200))
        self.pb_Power_Calculations.setStyleSheet("background-color: rgb(160, 255, 192);")
        self.pb_Power_Calculations.setObjectName("pb_Power_Calculations")
        self.gridLayout_6.addWidget(self.pb_Power_Calculations, 1, 0, 1, 1)
...
"NOMENCLATURE"))
        ...
        self.pb_Power_Calculations.setText(_translate("Misc", "Power Calculations"))
